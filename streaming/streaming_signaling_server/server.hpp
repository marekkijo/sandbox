...
private:
  ...
  void on_client_error(std::weak_ptr<Client> client, std::string error) const;
  void on_client_binary_message(std::weak_ptr<Client> client, rtc::binary message) const;
