...
misc::Event::ScanCode to_scan_code(const std::string &scan_code_string) {
  static const auto scan_code_map = std::unordered_map<std::string, misc::Event::ScanCode>{
      ...
      {                        "AudioMute",                         misc::Event::ScanCode::AudioMute},
      {                        "AudioNext",                         misc::Event::ScanCode::AudioNext},
      {                        "AudioPlay",                         misc::Event::ScanCode::AudioPlay},
      {                        "AudioPrev",                         misc::Event::ScanCode::AudioPrev},
      {                        "AudioStop",                         misc::Event::ScanCode::AudioStop},
      {                        "Backslash",                         misc::Event::ScanCode::Backslash},
      {                        "Backspace",                         misc::Event::ScanCode::Backspace},
      {                   "BrightnessDown",                    misc::Event::ScanCode::BrightnessDown},
      {                     "BrightnessUp",                      misc::Event::ScanCode::BrightnessUp},
      {                       "Calculator",                        misc::Event::ScanCode::Calculator},
      ...
      {                         "Computer",                          misc::Event::ScanCode::Computer},
      ...
      {                    "DisplaySwitch",                     misc::Event::ScanCode::DisplaySwitch},
      ...
      {         "KeyboardIlluminationDown",          misc::Event::ScanCode::KeyboardIlluminationDown},
      {       "KeyboardIlluminationToggle",        misc::Event::ScanCode::KeyboardIlluminationToggle},
      {           "KeyboardIlluminationUp",            misc::Event::ScanCode::KeyboardIlluminationUp},
...
const std::string &from_scan_code(const misc::Event::ScanCode scan_code) {
  static const auto scan_code_map = std::unordered_map<misc::Event::ScanCode, std::string>{
      ...
      {                        misc::Event::ScanCode::AudioMute,                         "AudioMute"},
      {                        misc::Event::ScanCode::AudioNext,                         "AudioNext"},
      {                        misc::Event::ScanCode::AudioPlay,                         "AudioPlay"},
      {                        misc::Event::ScanCode::AudioPrev,                         "AudioPrev"},
      {                        misc::Event::ScanCode::AudioStop,                         "AudioStop"},
      {                        misc::Event::ScanCode::Backslash,                         "Backslash"},
      {                        misc::Event::ScanCode::Backspace,                         "Backspace"},
      {                   misc::Event::ScanCode::BrightnessDown,                    "BrightnessDown"},
      {                     misc::Event::ScanCode::BrightnessUp,                      "BrightnessUp"},
      {                       misc::Event::ScanCode::Calculator,                        "Calculator"},
      ...
      {                         misc::Event::ScanCode::Computer,                          "Computer"},
      ...
      {                    misc::Event::ScanCode::DisplaySwitch,                     "DisplaySwitch"},
      ...
      {         misc::Event::ScanCode::KeyboardIlluminationDown,          "KeyboardIlluminationDown"},
      {       misc::Event::ScanCode::KeyboardIlluminationToggle,        "KeyboardIlluminationToggle"},
      {           misc::Event::ScanCode::KeyboardIlluminationUp,            "KeyboardIlluminationUp"},
